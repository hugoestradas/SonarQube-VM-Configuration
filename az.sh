...
az vm create --resource-group "poccodeanalysisrg" -n "vm" --image "Bitnami:sonarqube:6-4:8.2.2003100519" --size "Standard_B4ms" --admin-username "vmuser" --admin-password "Password@123" -l "eastus"
